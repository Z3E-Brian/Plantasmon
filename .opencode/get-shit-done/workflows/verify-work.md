...
<template>
@/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/workflows/transition.md`.
...
```bash
node "/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/workflows/diagnose-issues.md
