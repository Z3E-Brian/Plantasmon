...
```bash
node "/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/templates/retrospective.md`.
