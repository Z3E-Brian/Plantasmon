...
```
Task(
  prompt="Read /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/templates/VALIDATION.md`
