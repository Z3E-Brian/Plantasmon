...
- **Global scope**: `/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/notes/`)
...
2. Glob `/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/notes/` — works in any directory
