...
<required_reading>
@/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/references/ai-frameworks.md
@/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/agents/gsd-eval-planner.md for instructions.
