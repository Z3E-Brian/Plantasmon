...
Key references:
- @/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/USER-PROFILE.md" "/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /home/brian/4_anno/Moviles/Proyecto en clase/plantasmon/.opencode/AGENTS.md
```
